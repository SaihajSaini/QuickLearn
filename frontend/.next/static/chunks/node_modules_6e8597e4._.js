...
var Parser = function() {
    ...
    Parser.prototype.parseNumberSkeletonFromString = function(skeleton, location) {
        var tokens = [];
        try {
            tokens = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$formatjs$2f$icu$2d$messageformat$2d$parser$2f$node_modules$2f40$formatjs$2f$icu$2d$skeleton$2d$parser$2f$lib$2f$number$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseNumberSkeletonFromString"])(skeleton);
        } catch (e) {
...
"[project]/node_modules/@formatjs/icu-messageformat-parser/node_modules/@formatjs/icu-skeleton-parser/lib/date-time.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@formatjs/icu-messageformat-parser/node_modules/@formatjs/icu-skeleton-parser/lib/regex.generated.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@formatjs/icu-messageformat-parser/node_modules/@formatjs/icu-skeleton-parser/lib/number.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@formatjs/icu-messageformat-parser/node_modules/@formatjs/icu-skeleton-parser/lib/index.js [app-client] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@formatjs/icu-messageformat-parser/node_modules/@formatjs/icu-skeleton-parser/lib/index.js [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
function parseWithDictionary(dictionary, value) {
    ...
    for(const key in dictionary){
        ...
        ensureSynchronous(propResult, "Validation must be synchronous, but ".concat(key, " returned a Promise."));
...
*/ function createEnv(opts) {
    var _opts_createFinalSchema;
    var _opts_runtimeEnvStrict, _ref;
    const runtimeEnv = (_ref = (_opts_runtimeEnvStrict = opts.runtimeEnvStrict) !== null && _opts_runtimeEnvStrict !== void 0 ? _opts_runtimeEnvStrict : opts.runtimeEnv) !== null && _ref !== void 0 ? _ref : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env;
    var _opts_emptyStringAsUndefined;
    const emptyStringAsUndefined = (_opts_emptyStringAsUndefined = opts.emptyStringAsUndefined) !== null && _opts_emptyStringAsUndefined !== void 0 ? _opts_emptyStringAsUndefined : false;
    ...
    var _opts_isServer;
    const isServer = (_opts_isServer = opts.isServer) !== null && _opts_isServer !== void 0 ? _opts_isServer : typeof window === "undefined" || "Deno" in window;
    ...
    var _opts_createFinalSchema_standard_validate;
    const parsed = (_opts_createFinalSchema_standard_validate = (_opts_createFinalSchema = opts.createFinalSchema) === null || _opts_createFinalSchema === void 0 ? void 0 : _opts_createFinalSchema.call(opts, finalSchemaShape, isServer)["~standard"].validate(runtimeEnv)) !== null && _opts_createFinalSchema_standard_validate !== void 0 ? _opts_createFinalSchema_standard_validate : parseWithDictionary(finalSchemaShape, runtimeEnv);
    ensureSynchronous(parsed, "Validation must be synchronous");
    var _opts_onValidationError;
    const onValidationError = (_opts_onValidationError = opts.onValidationError) !== null && _opts_onValidationError !== void 0 ? _opts_onValidationError : (issues)=>{
        console.error("❌ Invalid environment variables:", issues);
        throw new Error("Invalid environment variables");
    };
    var _opts_onInvalidAccess;
    const onInvalidAccess = (_opts_onInvalidAccess = opts.onInvalidAccess) !== null && _opts_onInvalidAccess !== void 0 ? _opts_onInvalidAccess : ()=>{
    ...
    var _opts_extends;
    const extendedObj = ((_opts_extends = opts.extends) !== null && _opts_extends !== void 0 ? _opts_extends : []).reduce((acc, curr)=>{
...
//# sourceMappingURL=node_modules_6e8597e4._.js.map