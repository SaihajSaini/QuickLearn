...
import { PlaywrightSlimmedProp } from '../services/checkly-config-loader';
...
export default class PwTestCommand extends AuthCommand {
    ...
    static state: string;
    static flags: {
        location: import("@oclif/core/interfaces").OptionFlag<string, import("@oclif/core/interfaces").CustomOptions>;
    ...
    run(): Promise<void>;
    static createPlaywrightCheck(args: string[], runLocation: keyof Region, dir: string): Promise<PlaywrightSlimmedProp>;
