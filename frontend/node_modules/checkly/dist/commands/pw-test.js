...
class PwTestCommand extends authCommand_1.AuthCommand {
    ...
    async run() {
        ...
        const playwrightCheck = await PwTestCommand.createPlaywrightCheck(playwrightFlags, runLocation, dir);
        if (createCheck) {
    ...
    static async createPlaywrightCheck(args, runLocation, dir) {
