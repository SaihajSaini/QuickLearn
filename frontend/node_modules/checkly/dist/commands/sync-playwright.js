...
class SyncPlaywright extends baseCommand_1.BaseCommand {
    ...
    async run() {
        ...
        const pwtConfigAst = (0, write_config_helpers_1.findPropertyByName)(recast.parse(pwtConfig), 'playwrightConfig');
