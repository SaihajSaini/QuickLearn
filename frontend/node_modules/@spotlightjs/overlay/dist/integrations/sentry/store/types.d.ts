...
import { AggregateCallData, Sdk, SentryErrorEvent, SentryEvent, SentryLogEventItem, SentryProcessedProfile, Trace } from '../types';
...
export type SentryStoreState = EventsSliceState & TracesSliceState & ProfilesSliceState & SubscriptionsSliceState & SettingsSliceState & EnvelopesSliceState & LogsSliceState & SDKsSliceState;
export type SentryStoreActions = EventsSliceActions & TracesSliceActions & ProfilesSliceActions & SubscriptionsSliceActions & SettingsSliceActions & EnvelopesSliceActions & LogsSliceActions & SDKsSliceActions & SharedSliceActions;
