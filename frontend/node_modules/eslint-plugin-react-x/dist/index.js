...
function getMapIndexParamName(context, node) {
  ...
  return param != null && "name" in param ? param.name : eff.unit;
}
...
var RULE_NAME19 = "no-comment-textnodes";
var RULE_FEATURES19 = [];
...
var RULE_NAME20 = "no-complex-conditional-rendering";
var RULE_FEATURES20 = [
  "EXP"
];
...
var RULE_NAME21 = "no-component-will-mount";
var RULE_FEATURES21 = [
  "MOD"
];
...
var RULE_NAME22 = "no-component-will-receive-props";
var RULE_FEATURES22 = [
  "MOD"
];
...
var RULE_NAME23 = "no-component-will-update";
var RULE_FEATURES23 = [
  "MOD"
];
...
var RULE_NAME24 = "no-context-provider";
var RULE_FEATURES24 = [
  "MOD"
];
...
var RULE_NAME26 = "no-default-props";
var RULE_FEATURES26 = [];
...
function create26(context) {
  ...
  return {
    AssignmentExpression(node) {
      ...
      if (!AST8__namespace.isFunction(variableNode)) return;
      context.report({ messageId: "noDefaultProps", node: property });
    }
  };
}
var RULE_NAME27 = "no-direct-mutation-state";
var RULE_FEATURES27 = [];
...
function inspectVariantTypes(types) {
  ...
  if (booleans.length === 1 && boolean0 != null) {
    if (tsApiUtils.isFalseLiteralType(boolean0)) {
      variantTypes.add("falsy boolean");
    } else if (tsApiUtils.isTrueLiteralType(boolean0)) {
...
function create31(context) {
  ...
  function getReportDescriptor(node) {
    ...
    if (AST8__namespace.isJSX(node)) return eff.unit;
    ...
    return tsPattern.match(node).with({ type: types.AST_NODE_TYPES.LogicalExpression, operator: "&&" }, ({ left, right }) => {
      ...
      return tsPattern.match(variableDefNode).with({ init: tsPattern.P.select({ type: tsPattern.P.not(types.AST_NODE_TYPES.VariableDeclaration) }) }, getReportDescriptor).otherwise(() => eff.unit);
    }).otherwise(() => eff.unit);
  }
  return {
    ...
    "Program:exit"() {
      for (const call of createCalls) {
        ...
        if (!hasDisplayNameAssignment) {
          const semi = kit.LanguagePreference.defaultLanguagePreference.semicolons === "always" ? ";" : "";
          context.report({
            messageId: "noMissingContextDisplayName",
            node: id,
            fix(fixer) {
              if (id.type !== types.AST_NODE_TYPES.Identifier || id.parent !== call.parent) return [];
  ...
  return {
    ...
    "Program:exit"(program) {
      ...
      for (const { name: name5 = "unknown", node: component } of classComponents) {
        if (AST8__namespace.findParentNode(component, (n) => isClassComponent11(n) || isFunctionComponent(n)) == null) {
          continue;
        }
        context.report({
          messageId: "noNestedComponentDefinitions",
...
var RULE_NAME44 = "no-unsafe-component-will-mount";
var RULE_FEATURES44 = [];
...
var RULE_NAME45 = "no-unsafe-component-will-receive-props";
var RULE_FEATURES45 = [];
...
var RULE_NAME46 = "no-unsafe-component-will-update";
var RULE_FEATURES46 = [];
...
var RULE_NAME47 = "no-unstable-context-value";
var RULE_FEATURES47 = [];
...
var RULE_NAME48 = "no-unstable-default-props";
var RULE_FEATURES48 = [];
...
var RULE_NAME49 = "no-unused-class-component-members";
var RULE_FEATURES49 = [];
...
var RULE_NAME50 = "no-unused-state";
var RULE_FEATURES50 = [];
...
var RULE_NAME51 = "no-use-context";
var RULE_FEATURES51 = [
  "MOD"
];
...
var RULE_NAME52 = "no-useless-forward-ref";
var RULE_FEATURES52 = [];
...
var RULE_NAME53 = "no-useless-fragment";
var defaultOptions = [{
...
function create53(context, [option]) {
...
var RULE_NAME54 = "prefer-destructuring-assignment";
var RULE_FEATURES53 = [];
...
var RULE_NAME55 = "prefer-react-namespace-import";
var RULE_FEATURES54 = [
  "FIX"
];
...
var RULE_NAME56 = "prefer-read-only-props";
var RULE_FEATURES55 = [
  "TSC",
  "EXP"
];
...
var RULE_NAME57 = "prefer-shorthand-boolean";
var RULE_FEATURES56 = [
  "FIX"
];
...
var RULE_NAME58 = "prefer-shorthand-fragment";
var RULE_FEATURES57 = [
  "FIX"
];
