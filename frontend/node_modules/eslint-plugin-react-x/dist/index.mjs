...
import { flow, getOrElseUpdate, constTrue, constFalse, unit } from '@eslint-react/eff';
import { compare } from 'compare-versions';
import { getConstrainedTypeAtLocation, isTypeReadonly } from '@typescript-eslint/type-utils';
import { unionTypeParts, isTypeFlagSet, isFalseLiteralType, isTrueLiteralType } from 'ts-api-utils';
...
function create26(context) {
  ...
  return {
    AssignmentExpression(node) {
      ...
      if (!AST8.isFunction(variableNode)) return;
...
function create31(context) {
  ...
  function getReportDescriptor(node) {
    ...
    if (AST8.isJSX(node)) return unit;
  ...
  return {
    ...
    "Program:exit"(program) {
      ...
      for (const { name: name5 = "unknown", node: component } of classComponents) {
        if (AST8.findParentNode(component, (n) => isClassComponent11(n) || isFunctionComponent(n)) == null) {
          continue;
        }
        context.report({
          messageId: "noNestedComponentDefinitions",
