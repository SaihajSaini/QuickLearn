...
import { NextConfigObject, TurbopackOptions, TurbopackRuleConfigItemOrShortcut } from '../types';
/**
 ...
 */
export declare function constructTurbopackConfig({ userNextConfig, routeManifest, }: {
 ...
 */
export declare function safelyAddTurbopackRule(existingRules: TurbopackOptions['rules'], { matcher, rule }: {
    matcher: string;
