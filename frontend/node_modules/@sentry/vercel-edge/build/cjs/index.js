...
var Span = /** @class */ (function () {
    ...
    Span.prototype.recordException = function (exception, time) {
        ...
        if (typeof exception === 'string') {
            attributes[semanticConventions.SEMATTRS_EXCEPTION_MESSAGE] = exception;
        }
        else if (exception) {
            if (exception.code) {
                attributes[semanticConventions.SEMATTRS_EXCEPTION_TYPE] = exception.code.toString();
            }
            else if (exception.name) {
                attributes[semanticConventions.SEMATTRS_EXCEPTION_TYPE] = exception.name;
            }
            if (exception.message) {
                attributes[semanticConventions.SEMATTRS_EXCEPTION_MESSAGE] = exception.message;
            }
            if (exception.stack) {
                attributes[semanticConventions.SEMATTRS_EXCEPTION_STACKTRACE] = exception.stack;
            }
        }
        // these are minimum requirements from spec
        if (attributes[semanticConventions.SEMATTRS_EXCEPTION_TYPE] ||
            attributes[semanticConventions.SEMATTRS_EXCEPTION_MESSAGE]) {
...
var BatchSpanProcessorBase = /** @class */ (function () {
    ...
    BatchSpanProcessorBase.prototype._flushOneBatch = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            api.context.with(suppressTracing(api.context.active()), function () {
...
var BasicTracerProvider = /** @class */ (function () {
    function BasicTracerProvider(config) {
        ...
        this.resource = (_a = mergedConfig.resource) !== null && _a !== void 0 ? _a : resources.Resource.empty();
        if (mergedConfig.mergeResourceWithDefaults) {
            this.resource = resources.Resource.default().merge(this.resource);
        }
...
function init(options = {}) {
  ...
  opentelemetry.enhanceDscWithOpenTelemetryRootSpanName(client);
...
function setupOtel(client) {
  ...
  const provider = new BasicTracerProvider({
    ...
    resource: new resources.Resource({
      [semanticConventions.ATTR_SERVICE_NAME]: 'edge',
      // eslint-disable-next-line deprecation/deprecation
  ...
  const SentryContextManager = opentelemetry.wrapContextManagerClass(AsyncLocalStorageContextManager);
