...
import { ServerRuntimeClient, applySdkMetadata, defineIntegration, LRUMap, addFetchInstrumentationHandler, getClient, isSentryRequestUrl, instrumentFetchRequest, stringMatchesSomePattern, addBreadcrumb, getBreadcrumbLogLevelFromHttpStatusCode, createTransport, suppressTracing as suppressTracing$1, SENTRY_BUFFER_FULL_ERROR, GLOBAL_OBJ, debug as debug$1, createStackParser, nodeStackLineParser, dedupeIntegration, inboundFiltersIntegration, functionToStringIntegration, linkedErrorsIntegration, consoleIntegration, requestDataIntegration, getCurrentScope, getIntegrationsToSetup, stackParserFromStackParserOptions, SDK_VERSION, hasSpansEnabled, addVercelAiProcessors, _INTERNAL_captureLog, fmt } from '@sentry/core';
...
import { createContextKey, baggageEntryMetadataFromString, propagation, diag, DiagLogLevel, trace as trace$1, isSpanContextValid, TraceFlags, SpanStatusCode, isValidTraceId, context, ROOT_CONTEXT } from '@opentelemetry/api';
import { Resource } from '@opentelemetry/resources';
import { SEMATTRS_EXCEPTION_TYPE, SEMATTRS_EXCEPTION_MESSAGE, SEMATTRS_EXCEPTION_STACKTRACE, ATTR_SERVICE_VERSION, SEMRESATTRS_SERVICE_NAMESPACE, ATTR_SERVICE_NAME } from '@opentelemetry/semantic-conventions';
import { setOpenTelemetryContextAsyncContextStrategy, enhanceDscWithOpenTelemetryRootSpanName, setupEventContextTrace, SentrySpanProcessor, SentrySampler, wrapContextManagerClass, SentryPropagator, openTelemetrySetupCheck } from '@sentry/opentelemetry';
...
export { VercelEdgeClient, getDefaultIntegrations, init, exports as logger, vercelAIIntegration, winterCGFetchIntegration };
