import { createCli, pickOptions, validateHost, validateOptions } from "./_chunks/util-MDbeGwC0.mjs";
...
async function run() {
	...
	if (unlighthouse.resolvedConfig.server.open) await open(unlighthouse.runtimeSettings.clientUrl);
}
run();
